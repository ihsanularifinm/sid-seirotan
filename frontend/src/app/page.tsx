          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-2xl mx-auto">
            {kepalaDesa && (
              <div className="text-center">
                <Image src={kepalaDesa.photo_url ? `http://localhost:8081${kepalaDesa.photo_url}` : '/assets/img/placeholder.png'} alt={kepalaDesa.name} width={128} height={128} className="w-32 h-32 rounded-full mx-auto mb-4 object-cover shadow-lg border-4 border-white" unoptimized />
            ...
            {sekretarisDesa && (
              <div className="text-center">
                <Image src={sekretarisDesa.photo_url ? `http://localhost:8081${sekretarisDesa.photo_url}` : '/assets/img/placeholder.png'} alt={sekretarisDesa.name} width={128} height={128} className="w-32 h-32 rounded-full mx-auto mb-4 object-cover shadow-lg border-4 border-white" unoptimized />
