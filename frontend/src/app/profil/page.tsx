	...
	return (
		<main className="container mx-auto px-4 py-12">
			...
			<section className="mb-16">
				...
				<p className="text-gray-600 leading-relaxed">Desa Sei Rotan adalah salah satu desa di Kecamatan Percut Sei Tuan, Kabupaten Deli Serdang, Provinsi Sumatera Utara. Desa ini memiliki sejarah panjang yang berkaitan erat dengan perkembangan perkebunan tembakau di era kolonial Belanda. Nama &#34;Sei Rotan&#34; sendiri konon berasal dari banyaknya tanaman rotan yang tumbuh di sepanjang sungai yang melintasi desa ini. Seiring berjalannya waktu, Desa Sei Rotan berkembang menjadi pemukiman yang padat dengan berbagai mata pencaharian warganya, mulai dari pertanian, perdagangan, hingga industri kecil.</p>
			</section>
			...
			<section>
				...
				<div className="flex justify-center">
					<Image src="/assets/img/struktur-organisasi.png" alt="Struktur Organisasi Desa Sei Rotan" width={1000} height={700} className="rounded-lg shadow-md" />
				</div>
			</section>
		</main>
	);
